...
var ImageOrientation = (function () {
    function ImageOrientation() {
    }
    ImageOrientation.applyExifRotation = function (file) {
        var _this = this;
    ...
    ;
    ImageOrientation.readOrientation = function (file) {
    ...
    ImageOrientation.applyTransform = function (ctx, orientation, width, height) {
        switch (orientation) {
            case 2:
    ...
    ImageOrientation.arrayBufferToBase64 = function (buffer) {
        var binary = '';
    ...
    ImageOrientation.isExifSupported = function () {
...
//# sourceMappingURL=image.orientation.js.map