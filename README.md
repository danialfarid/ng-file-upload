...
**See the <a href="https://angular-file-upload.appspot.com/" target="_blank">DEMO</a> page**.<br/> [docs](https://github.com/danialfarid/ng-file-upload/blob/master/README.md)
